...
// =====================================================================================================================
const Types = new TypeChecker();
Types.set('mongo', { parent: 'string', validator: validatorLib.isMongoId });
Types.set('uuid', { parent: 'string', validator: validatorLib.isUUID });
Types.set('md5', { parent: 'string', validator: validatorLib.isMD5 });
Types.set('base64', { parent: 'string', validator: validatorLib.isBase64 });
Types.set('ip', { parent: 'string', validator: validatorLib.isIP });

Types.set('url', { parent: 'trim', validator: validatorLib.isURL });
Types.set('uri', { parent: 'trim', validator: validatorLib.isDataURI });
Types.set('magnet', { parent: 'trim', validator: validatorLib.isMagnetURI });
Types.set('email', { parent: 'trim', validator: validatorLib.isEmail });
...
class Parameter {
  constructor(field, {
    ...
    this.checker = Types.disjunctive(lodash.isArray(type) ? type : [type]);
